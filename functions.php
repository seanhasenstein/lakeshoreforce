...
function theme_styles() {
	...
	wp_enqueue_style( 'googlefont_css', 'https://fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic|Francois+One|Lato:400,100,100italic,300,300italic,400italic,700,700italic' );
...
function theme_js() {
	...
	wp_enqueue_script( 'twitter_js', get_template_directory_uri() . '/js/exampleUsage.js', array('jquery'), '', true );
}
